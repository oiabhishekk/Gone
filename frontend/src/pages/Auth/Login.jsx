        ...
        <div className="mr-[4rem] mt-[5rem] ">
          ...
          <form onSubmit={submitHandler} className='container w-[40rem]' >
            <div className="my-[2rem]">
              <label htmlFor="email" className=' block text-sm font-medium text-white' >Email Address
              </label>
              <input type="email" id='email' className='mt-1 p-2 border rounded w-full' value={email} onChange={(e) => setEmail(e.target.value)} />

            </div>
            <div className="my-[2rem]">
              <label htmlFor="password" className=' block text-sm font-medium text-white' >Password
              </label>
          ...
          <div className="mt-4">
            <p className="text-white">
              New customer ? {" "}
              <Link to={redirect ? `/register?redirect=${redirect}` : `/redirect`} className='text-pink-500 hover:underline' >Register
              </Link>
            </p>
          </div>
        </div>
